...
import { createRankedMatch, getPlayerRank, RankedError } from '@/lib/ranked';
...
it('shows the founder-facing error and does not call onCreated when createRankedMatch rejects', async () => {
  mockCreateRankedMatch.mockRejectedValue(new RankedError('Party rank difference too large.'));
