...
/**
 * One sheet, two entry points: the first time a calibrated player with
 * no booked court taps Find match (confirm mode — see play.tsx's
 * `confirmBeforeCreate`), and any time after that via the permanent
 * one-line reminder on the same screen (info mode). Same explanation,
 * same VenueRequestForm — reused, not duplicated, exactly as for the
 * lobby vs. Explore's empty state.
 */
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        <View style={[styles.header, { borderBottomColor: theme.border }]}>
          <ThemedText type="heading">Playing without a booking</ThemedText>
